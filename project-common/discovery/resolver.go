...
// There's a bug: the type of target.Endpoint has been changed?
// And target.Authority doesn't exist.
func (r *Resolver) Build(target resolver.Target, cc resolver.ClientConn, opts resolver.BuildOptions) (resolver.Resolver, error) {
	r.cc = cc

	r.keyPrifix = BuildPrefix(Server{Name: target.Endpoint, Version: opts.Authority})
